...
## This is old version of event queue, which isn't working since gdscript doesn't support array destructurers.
## eg. I can't make function like append_signal(signal: Signal, array: Array): signal.emit(...array)
extends Node
...
func emit_dynamic_signal(signal_to_emit: Signal, args: Array) -> void:
	print("signal_to_emit: ", signal_to_emit)
	print("args: ", args)
